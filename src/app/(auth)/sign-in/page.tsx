    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-black text-white">
      <div className="w-full max-w-md p-8 space-y-8 bg-gray-900 m-4 border rounded-lg shadow-lg transform transition-all hover:scale-100">
        <div className="text-center">
          ...
          <p className="mb-6 text-gray-400">Sign in to continue your secret conversations</p>
        </div>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Input {...field} className="bg-gray-800 border border-gray-600 text-white" />
                  <FormMessage />
                </FormItem>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Input type="password" {...field} className="bg-gray-800 border border-gray-600 text-white" />
                  <FormMessage />
                </FormItem>
              )}
            />
            <Button className="w-full bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 transition-colors" type="submit" disabled={loadingSignIn}>
              {loadingSignIn ? <Loader2 className="animate-spin mx-auto" /> : 'Sign In'}
            </Button>
          </form>
        </Form>
        <Button
        ...
        >
          {loadingGithub ? <Loader2 className="animate-spin mx-auto" /> : 'Sign in with GitHub'}
        </Button>
